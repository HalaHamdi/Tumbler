...
//                Html.fromHtml("<font color='#E91E63'>" + "I'm sure"), DialogInterface.OnClickListener {
//                        dialog, which -> findNavController().navigate(SignUpFragmentDirections.actionSignUpFragmentToLoginSignupFragment())
//                }
//            )
